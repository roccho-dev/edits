...
This PR deliberately does not introduce LSP/JSON-RPC. It records provider-port evidence and import instructions; the runnable overlay artifact remains referenced by hash.
